<%@ Page Language="C#" MasterPageFile="~/Aspx/Common/testBlankScreen.master" AutoEventWireup="true" Inherits="Aspx_testFxLayerP_wcc_testWCTextBox" Title="Untitled Page" Codebehind="testWCTextBox.aspx.cs" %>
         ...
         <tr>
            ...
            <td>：
                <cc1:WebCustomTextBox ID="WebCustomTextBox2" runat="server" BackColor="skyblue">
                    <CheckType Indispensable="True"></CheckType>
                </cc1:WebCustomTextBox>
            </td>
        </tr>
         <tr>
