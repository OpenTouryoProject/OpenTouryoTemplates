...
Namespace Touryo.Infrastructure.Business.Presentation
	...
	Public MustInherit Class MyBaseController
		...
		Private Sub CMN_FormInit(eventName As String)
			...
			Me.Page.Title = GetConfigParameter.GetConfigValue("BrowserTitle") & "（" & Convert.ToString(Me.ContentPageFileNoEx) & "）"
			' -------------------------------------------------------------
			...
			' ------------
            Dim strLogMessage As String = ("," & Convert.ToString(UserInfo.UserName) & ",") & Request.UserHostAddress & "," & eventName & "," & Convert.ToString(Me.ContentPageFileNoEx)
		...
		Protected Overrides Sub UOC_PreAction(fxEventArgs As FxEventArgs)
			...
			' エラーメッセージID, エラーメッセージ等
			' ------------
            Dim strLogMessage As String = ("," & Convert.ToString(UserInfo.UserName) & ",") & Request.UserHostAddress & "," & "----->" & "," & Convert.ToString(Me.ContentPageFileNoEx) & "," & Convert.ToString(fxEventArgs.ButtonID)
		...
		Protected Overrides Sub UOC_AfterAction(fxEventArgs As FxEventArgs)
			...
			' エラーメッセージID, エラーメッセージ等
			' ------------
            Dim strLogMessage As String = ("," & Convert.ToString(UserInfo.UserName) & ",") & Request.UserHostAddress & "," & "<-----" & "," & Convert.ToString(Me.ContentPageFileNoEx) & "," & Convert.ToString(fxEventArgs.ButtonID) & "," & "" & "," & Convert.ToString(perfRec.ExecTime) & "," & Convert.ToString(perfRec.CpuTime)
		...
		Protected Overrides Sub UOC_ABEND(baEx As BusinessApplicationException, fxEventArgs As FxEventArgs)
			...
			' エラーメッセージID, エラーメッセージ等
			' ------------
            Dim strLogMessage As String = ("," & Convert.ToString(UserInfo.UserName) & ",") & Request.UserHostAddress & "," & "<-----" & "," & Convert.ToString(Me.ContentPageFileNoEx) & "," & Convert.ToString(fxEventArgs.ButtonID) & "," & "" & "," & Convert.ToString(Me.perfRec.ExecTime) & "," & Convert.ToString(Me.perfRec.CpuTime) & "," & Convert.ToString(baEx.messageID) & "," & Convert.ToString(baEx.Message)
		...
		Protected Overrides Sub UOC_ABEND(bsEx As BusinessSystemException, fxEventArgs As FxEventArgs)
			...
			' エラーメッセージID, エラーメッセージ等
			' ------------
            Dim strLogMessage As String = ("," & Convert.ToString(UserInfo.UserName) & ",") & Request.UserHostAddress & "," & "<-----" & "," & Convert.ToString(Me.ContentPageFileNoEx) & "," & Convert.ToString(fxEventArgs.ButtonID) & "," & "" & "," & Convert.ToString(Me.perfRec.ExecTime) & "," & Convert.ToString(Me.perfRec.CpuTime) & "," & Convert.ToString(bsEx.messageID) & "," & Convert.ToString(bsEx.Message) & vbCr & vbLf
		...
		Protected Overrides Sub UOC_ABEND(ex As Exception, fxEventArgs As FxEventArgs)
			...
			' エラーメッセージID, エラーメッセージ等
			' ------------
            Dim strLogMessage As String = ("," & Convert.ToString(UserInfo.UserName) & ",") & Request.UserHostAddress & "," & "<-----" & "," & Convert.ToString(Me.ContentPageFileNoEx) & "," & Convert.ToString(fxEventArgs.ButtonID) & "," & "" & "," & Convert.ToString(Me.perfRec.ExecTime) & "," & Convert.ToString(Me.perfRec.CpuTime) & "," & "other Exception" & "," & ex.Message & vbCr & vbLf
			' OriginalStackTrace（ログ出力）の品質向上
			If Me.OriginalStackTrace = "" Then
		...
		Public Shared Sub TransferErrorScreen2(ex As Exception)
            ...
            err_msg = System.Environment.NewLine & "エラーメッセージＩＤ: " & errMsgId & System.Environment.NewLine & "エラーメッセージ: " & ex.Message.ToString()

            ' #19-start
            err_info = System.Environment.NewLine & "対象URL: " & HttpContext.Current.Request.Url.ToString() & System.Environment.NewLine & "スタックトレース:" & ex.StackTrace.ToString() & System.Environment.NewLine & "Exception.ToString():" & ex.ToString()
            ' #19-end
...
#Region "sampleScreen.masterマスタ ページ上のフレームワーク対象コントロールの、共通イベントのUOCメソッド"
        ...
        ''' <param name="fxEventArgs">イベントハンドラの共通引数</param>
        ''' <returns>URL</returns>
        Public Function UOC_sampleScreen_btnMButton101_Click(ByVal fxEventArgs As FxEventArgs) As String
            ' ログオフ（認証チケットを削除する）
...
#Region "基本処理"
        ...
        ''' <param name="fxEventArgs">イベントハンドラの共通引数</param>
        ''' <returns>URL</returns>
        Public Function UOC_TestScreen1_btnMButton1_Click(ByVal fxEventArgs As FxEventArgs) As String
            ' メッセージ表示
        ...
        ''' <param name="fxEventArgs">イベントハンドラの共通引数</param>
        ''' <returns>URL</returns>
        Public Function UOC_TestScreen1_lbnMLinkButton1_Click(ByVal fxEventArgs As FxEventArgs) As String
            ' メッセージ表示
            Me.ShowOKMessageDialog(Convert.ToString(fxEventArgs.ButtonID) & "クリック イベント", Convert.ToString(fxEventArgs.MethodName) & "の実行", FxEnum.IconType.Information, "テスト結果")
        ...
        ''' <param name="fxEventArgs">イベントハンドラの共通引数</param>
        ''' <returns>URL</returns>
        Public Function UOC_TestScreen1_ibnMImageButton1_Click(ByVal fxEventArgs As FxEventArgs) As String
            ' メッセージ表示
        ...
        ''' <param name="fxEventArgs">イベントハンドラの共通引数</param>
        ''' <returns>URL</returns>
        Public Function UOC_TestScreen1_impMImageMap1_Click(ByVal fxEventArgs As FxEventArgs) As String
            ' メッセージ表示
...
#Region "コントロール取得"
        ...
        ''' <param name="fxEventArgs">イベントハンドラの共通引数</param>
        ''' <returns>URL</returns>
        Public Function UOC_TestScreen1_btnMButton3_Click(ByVal fxEventArgs As FxEventArgs) As String
            ' コントロールを取得し
        ...
        ''' <param name="fxEventArgs">イベントハンドラの共通引数</param>
        ''' <returns>URL</returns>
        Public Function UOC_TestScreen1_lbnMLinkButton3_Click(ByVal fxEventArgs As FxEventArgs) As String
            ' コントロールを取得し
        ...
        ''' <param name="fxEventArgs">イベントハンドラの共通引数</param>
        ''' <returns>URL</returns>
        Public Function UOC_TestScreen1_ibnMImageButton3_Click(ByVal fxEventArgs As FxEventArgs) As String
            ' コントロールを取得し
...
#Region "ダイアログ表示"
        ...
        ''' <param name="fxEventArgs">イベントハンドラの共通引数</param>
        ''' <returns>URL</returns>
        Public Function UOC_TestScreen1_btnMButton4_Click(ByVal fxEventArgs As FxEventArgs) As String
            ' スタイルを取得
        ...
        ''' <param name="fxEventArgs">イベントハンドラの共通引数</param>
        ''' <returns>URL</returns>
        Public Function UOC_TestScreen1_lbnMLinkButton4_Click(ByVal fxEventArgs As FxEventArgs) As String
            ' スタイルを取得
            Dim style As String = DirectCast(Me.GetMasterWebControl("TextBox2"), TextBox).Text
...
#Region "TestScreen2.masterマスタ ページ上のフレームワーク対象コントロールの、共通イベントのUOCメソッド"
        ...
        ''' <param name="fxEventArgs">イベントハンドラの共通引数</param>
        ''' <returns>URL</returns>
        Public Function UOC_TestScreen2_btnMButton1_Click(ByVal fxEventArgs As FxEventArgs) As String
            ' 動作確認のため、３秒待つ。
