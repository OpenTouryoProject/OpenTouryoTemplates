# Open Touryo Template Base for Visual Studio 2013
...
You can run the sample application bundled with Open Touryo Template Base for Visual Studio 2013 according to the following steps.

##### Install prerequisites
Install Visual Studio 2013 and SQL Server Express beforehand.  
**Note**:  
...
Copy *root_VS2013* folder to C drive.  
And rename *root_VS2013* folder to *root*.
...
- The libraries which are used by Open Touryo Template Base for Visual Studio 2013 are downloaded by NuGet. NuGet libraries might not be downloaded normally under proxy environment. So, when using proxy environment, create environment variable *http_proxy* as follows:
