...
If not copying *root_VS2017* folder to just under C drive, the build may fail for the Windows maximum path length limitation.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>3_Build_NetCore.bat</td><td>Build the .NET Core-based framework. (Base class 2 and library part)</td><td style="vertical-align: top">△<span style="color: red"><sup>*4</sup></span></td><td></td>
    </tr>
    <tr>
