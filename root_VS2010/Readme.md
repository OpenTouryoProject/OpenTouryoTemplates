# Open Touryo Template Base for Visual Studio 2010
...
You can run the sample application bundled with Open Touryo Template Base for Visual Studio 2010 according to the following steps.

##### Install prerequisites
Install Visual Studio 2010 and SQL Server Express beforehand.  
**Note**:  
...
Copy *root_VS2010* folder to C drive.  
And rename *root_VS2010* folder to *root*.
