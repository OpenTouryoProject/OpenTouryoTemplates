# Open 棟梁 Visual Studio2012 テンプレート・ベースの利用方法(How to Use OpenTouryo Visual Studio 2012 template base)

### 手順(procedure)
Open棟梁 Visual Studio2012 テンプレート・ベースに同梱されるサンプルの実行手順は下記のとおりです。  
(Execution procedure of the samples that are shipped with the OpenTouryo Visual Studio 2012 template base is as follows.)

##### 配置(Deploy)
「/root_VS2012/」以下のフォルダを「C:\root」フォルダ以下に配置します。  
(Deploy to under 「C:\root」folder from under 「/root_VS2012/」folder.)

##### インストール(Install)
Visual Studio 2012 と SQL Server Express のインストール  
(Installing Visual Studio 2012 and SQL Server Express.)
