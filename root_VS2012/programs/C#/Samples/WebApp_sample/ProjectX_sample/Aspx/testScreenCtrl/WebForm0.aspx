...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_A" Runat="Server">
    ...
    <cc1:WebCustomButton ID="btnButton28" runat="server" Text="取得" /><br />
    <br />
    汎用画面遷移：<br />
    ラベル ｏｒ ＵＲＬ：
    <cc1:WebCustomTextBox ID="TextBox2" runat="server"></cc1:WebCustomTextBox><br />
    画面遷移方法：
    <cc1:WebCustomButton ID="btnButton29" runat="server" Text="ScreenTransition" Width="150px" />
    <cc1:WebCustomButton ID="btnButton30" runat="server" Text="FxTransfer" Width="120px" />
    <cc1:WebCustomButton ID="btnButton31" runat="server" Text="FxRedirect" Width="120px" />
    <cc1:WebCustomButton ID="btnButton32" runat="server" Text="Transfer" Width="120px" />
