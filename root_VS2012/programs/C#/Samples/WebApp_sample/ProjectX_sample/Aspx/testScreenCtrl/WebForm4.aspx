<%@ Page Language="C#" MasterPageFile="~/Aspx/Common/testScreenCtrl.master" AutoEventWireup="True" Inherits="ProjectX_sample.Aspx.testScreenCtrl.WebForm4" Title="Untitled Page" Codebehind="WebForm4.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_A" Runat="Server">
    ...
    <br />
    <asp:Image ID="Image1" runat="server" ImageUrl="./sc4.PNG" /><br />
</asp:Content>
