<%@ Page Language="C#" MasterPageFile="~/Aspx/Common/testScreenCtrl.master" AutoEventWireup="True" Inherits="ProjectX_sample.Aspx.testScreenCtrl.WebForm1" Title="Untitled Page" Codebehind="WebForm1.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_A" Runat="Server">
    ...
    <br />
    <asp:Image ID="Image1" runat="server" ImageUrl="./sc1.PNG" /><br />
</asp:Content>
