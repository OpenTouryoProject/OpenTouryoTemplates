...
Namespace Touryo.Infrastructure.Business.Presentation
	...
	Public Class MyBaseMVController
		...
		Protected Overrides Sub OnActionExecuting(filterContext As ActionExecutingContext)
			...
			Dim strLogMessage As String = (", -" & ",") + Request.UserHostAddress & "," & "<-----" & "," & filterContext.Controller.ToString() & "," & Convert.ToString(filterContext.ActionDescriptor.ActionName) & "," & "OnActionExecuting" & "," & Convert.ToString(perfRec.ExecTime) & "," & Convert.ToString(perfRec.CpuTime)
		...
		Protected Overrides Sub OnActionExecuted(filterContext As ActionExecutedContext)
			...
			Dim strLogMessage As String = (", -" & ",") + Request.UserHostAddress & "," & "<-----" & "," & filterContext.Controller.ToString() & "," & Convert.ToString(filterContext.ActionDescriptor.ActionName) & "," & "OnActionExecuted" & "," & Convert.ToString(perfRec.ExecTime) & "," & Convert.ToString(perfRec.CpuTime)
		...
		Protected Overrides Sub OnException(filterContext As ExceptionContext)
			...
			err_msg = System.Environment.NewLine & "エラーメッセージＩＤ: " & errMsgId & System.Environment.NewLine & "エラーメッセージ: " & filterContext.Exception.Message.ToString()

			err_info = System.Environment.NewLine & "対象URL: " & Request.Url.ToString() & System.Environment.NewLine & "スタックトレース:" & filterContext.Exception.StackTrace.ToString() & System.Environment.NewLine & "Exception.ToString():" & filterContext.ToString()
			...
			' Logging.
			Dim strLogMessage As String = (", -" & ",") + Request.UserHostAddress & "," & "<-----" & "," & filterContext.Controller.ToString() & " - " & "OnException" & " - " & Convert.ToString(filterContext.Exception.Message)
		...
		Protected Overrides Sub OnResultExecuting(filterContext As ResultExecutingContext)
			...
			' Logging.
			Dim strLogMessage As String = (", -" & ",") + Request.UserHostAddress & "," & "<-----" & "," & filterContext.Controller.ToString() & "," & Convert.ToString(filterContext.Result) & "," & "OnResultExecuting" & "," & Convert.ToString(perfRec.ExecTime) & "," & Convert.ToString(perfRec.CpuTime)
		...
		Protected Overrides Sub OnResultExecuted(filterContext As ResultExecutedContext)
			...
			' Logging.
			Dim strLogMessage As String = (", -" & ",") + Request.UserHostAddress & "," & "<-----" & "," & filterContext.Controller.ToString() & "," & Convert.ToString(filterContext.Result) & "," & "OnResultExecuted" & "," & Convert.ToString(perfRec.ExecTime) & "," & Convert.ToString(perfRec.CpuTime)
